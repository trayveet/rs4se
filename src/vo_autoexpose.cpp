...
ExposureParameters ExpGainController::update_params(int score,int corrections,int blur_estim){
    ...
    for(int ii=0;ii<control_params.n_corrections;ii++)
    {
        // Debug
         ...
         //std::cout << "Intensity before Correction      " << img_mean_I[0] << std::endl;
        ...
        if(score==GRADINFO_SCORE){
            ...
            //  Debug
             ...
             //std::cout << "Delta Intensity after Correction " << img_tmp_mean_I[0]-img_mean_I[0] << std::endl;
    ...
    if(Imean<control_params.Imin){
        std::cout << "Image is too dark ! " << Imean << std::endl;
        ...
        std::cout << "Image is too bright ! " << Imean << std::endl;
 ...
 */
    ...
    // Debug
     ...
     //std::cout << "Buffer Size " << cameras[0].frames.size() << std::endl;
